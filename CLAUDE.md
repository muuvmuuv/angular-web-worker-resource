...
- **lib/types.ts**: TypeScript type definitions
  - `WebWorkerResourceOptions<TParams, TResult>` - Configuration for params, worker factory, transfer objects, and default value
...
Example Angular app demonstrating library usage (not yet updated for the new library).
